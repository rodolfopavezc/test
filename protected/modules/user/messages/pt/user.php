...
return array(
	...
	'You registered from {site_name}' => 'VocÃª se cadastrou no site {site_name}',
    ...
    'You account is not activated.' => "Sua conta nÃ£o está ativada.",
    'You account is blocked.' => 'Sua conta está bloqueada.',
    'Password is incorrect.' => 'Senha incorreta.',
    'E-mail' => 'Email',
    'Verification Code' => 'Código de verificaÃ§Ã£o',
    'Retype Password' => 'Redigite a senha',
    'Retype Password is incorrect.' => 'A redigitaÃ§Ã£o de senha está incorreta.',
    ...
    'Letters are not case-sensitive.' => 'As letras nÃ£o diferenciam de maiúsculas e minúsculas.',
    'Minimal password length 4 symbols.' => 'A senha deve ter no mínimo 4 caracteres.',
    'Lost Password?' => 'Esqueceu a senha?',
    'Profile' => 'Perfil',
    'activation key' => "Chave de ativaÃ§Ã£o",
    'User activation' => "AtivaÃ§Ã£o de usuário",
    'You account is active.' => 'Sua conta está ativa.',
    'You account is activated.' => 'Sua conta está ativada.',
    'Incorrect activation URL.' => 'A URL de ativaÃ§Ã£o está incorreta.',
    ...
    'Thank you for your registration. Please check your email or login.' => "Obrigado por cadastrar-se. Dentro de poucos minutos vocÃª receberá um email com as instruÃ§Ãµes para ativaÃ§Ã£o de seu login.",
    'Thank you for your registration. Please check your email.' => "Obrigado por cadastrar-se. Dentro de poucos minutos vocÃª receberá um email com as instruÃ§Ãµes para ativaÃ§Ã£o de seu login.",
    'Please check your email. An instructions was sent to your email address.' => "Por favor verifique seu email. As instruÃ§Ãµes já foram enviadas.",
    ...
    'Incorrect recovery link.' => 'Vínculo de recuperaÃ§Ã£o incorreto.',
    ...
    'No, but show on registration form' => 'NÃ£o, más mostre-me o formulário de cadastro',
    'Not active' => 'Inativo',
    'Active' => 'Ativo',
	'Banned' => 'Banido',
    ...
    'Fields with <span class="required">*</span> are required.' => 'Os campos com <span class="required"> * </span> sÃ£o obrigatórios.',
    ...
    'Changes are saved.' => 'AtualizaÃ§Ãµes realizadas com sucesso.',
    ...
    'Other Validator' => 'Outra validaÃ§Ã£o',
    ...
    'Allowed lowercase letters and digits.' => 'SÃ£o permitidas letras minúsculas e números',
    ...
    'The minimum value of the field (form validator).' => 'O valor mínimo do campo (validaÃ§Ã£o de formulário)',
    'Required field (form validator).' => 'Campo obrigatório (validaÃ§Ã£o de formulário)',
    'Regular expression (example: \'/^[A-Za-z0-9\s,]+$/u\').' => 'ExpressÃ£o regular (exemplo: \'/^[A-Za-z0-9\s,]+$/u\').',
    'Predefined values (example: 1;2;3;4;5 or 1==One;2==Two;3==Three;4==Four;5==Five).' => 'Valores predefinidos (exemplo: 1;2;3;4;5 o 1==Um;2==Dois;3==TrÃªs;4==Quatro;5==Cinco).',
    'Error message when you validate the form.' => 'Mensagem de erro quando valida o formulário.',
    'The value of the default field (database).' => 'O valor padrÃ£o do campo (base de dados)',
    'Display order of fields.' => 'Mostrar ordenaÃ§Ã£o dos campos',
	'Not visited' => 'NÃ£o visitou',
