...
return array(
        ...
        'This user\'s name already exists.' => 'Le nom de cet utilisateur existe déjÃ .',
        'This user\'s email address already exists.' => 'Adresse e-mail de cet utilisateur existe déjÃ .',
        'You registered from {site_name}' => 'Vous vous Ãªtes inscrit sur le site {site_name}',
        'Please activate you account go to {activation_url}' => "Pour activer votre compte s'il vous plaÃ®t cliquer sur le lien suivant {activation_url}",
        ...
        'Incorrect username (length between 3 and 20 characters).' => "Nom d'utilisateur incorrect (longueur entre 3 et 20 caractÃ¨res).",
        'Incorrect symbol\'s. (A-z0-9)' => 'Incorrect symbole. (A-z0-9)',
        'Variable name may consist of a-z, 0-9, underscores, begin with a letter.'=>'Nom de la variable peut Ãªtre composé de az, 0-9, souligne, commencer par une lettre.',
        "Length of ' + n + ' must be between '+min+' and '+max+'."=>"Durée de ' + n + ' doit Ãªtre compris entre '+min+' et '+max+'.",
        'Please enter the letters as they are shown in the image above.' => "S'il vous plaÃ®t entrez les lettres telles qu'elles figurent dans l'image ci-dessus.",
        'Letters are not case-sensitive.' => 'Lettres ne sont pas sensibles Ã  la casse.',
        ...
        'Thank you for your registration. Please check your email or login.' => "Nous vous remercions de votre inscription. S'il vous plaÃ®t vérifier votre e-mail ou login.",
        'Thank you for your registration. Please check your email.' => "Nous vous remercions de votre inscription. S'il vous plaÃ®t vérifier votre email.",
        'Please check your email. An instructions was sent to your email address.' => "S'il vous plaÃ®t vérifier votre email. Une instruction a été envoyée Ã  votre adresse e-mail.",
        'Thank you for your registration. Please {{login}}.' =>  'Nous vous remercions de votre inscription. S\'il vous plaÃ®t {{login}}.',
        ...
        'Restore' => 'Restaurer',
        'Please enter your login or email addres.' => "S'il vous plaÃ®t entrer votre login ou votre adresse e-mail.",
        'Incorrect recovery link.' => 'Récupération lien incorrect.',
        'Already exists.' => 'Existe déjÃ .',
        'First Name' => 'Prénom',
        'Last Name' => 'Nom',
        'No' => 'Aucun',
        'Yes' => 'Oui',
        ...
        'Active' => 'Actif',
        'Banned' => 'Banni',
        'Please fill out the following form with your login credentials:' => "S'il vous plaÃ®t remplir le formulaire suivant avec vos identifiants de connexion:",
        ...
        'Users' => 'Utilisateurs',
        'Update User' => 'Mise Ã  jour User',
        'Delete User' => 'Supprimer l\'utilisateur',
        'Delete file' => 'Supprimer le fichier',
        'View User' => 'Voir utilisateur',
        'Are you sure to delete this item?' => 'Etes-vous sÃ»r de vouloir supprimer cet élément?',
        ...
        'JSON string (example: {example}).' => 'ChaÃ®ne JSON (exemple: {example}).',
        'Default' => 'Par défaut',
        'Position' => 'Position',
        'Visible' => 'Visible',
        ...
        'Update Profile Field' => 'Mise Ã  jour le profil de terrain',
        'Widget'=>'Widget',
        ...
        "Regular expression (example: '/^[A-Za-z0-9\s,]+$/u')." => "Expression réguliÃ¨re (par exemple: '/^[A-Za-z0-9\s,]+$/u').",
